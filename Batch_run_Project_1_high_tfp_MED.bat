...
copy .\tfp_growth_rate3_MED.txt  .\tfp_growth_rate.txt  >> result_%File_Name%_high_TFP_%YYYYMMDD%.txt 2>&1
...
copy  .\file_out\trantf_JP.dat .\file_out\trantf_%File_Name%_grate%tfp_rate%_MED.dat >> result_%File_Name%_high_TFP_%YYYYMMDD%.txt 2>&1
