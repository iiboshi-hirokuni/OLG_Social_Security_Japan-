...
for %%n in (1,1,2) do (
   ...
   if  %%n == 1  (copy .\file_in\trantf_JP_%File_Name_1%.inp  .\file_in\trantf_XX.inp)
   if  %%n == 2 (copy .\file_in\trantf_JP_%File_Name_2%.inp  .\file_in\trantf_XX.inp)
   if  %%n == 3 (copy .\file_in\trantf_JP_%File_Name_3%.inp  .\file_in\trantf_XX.inp)                              
   
    rem  set File_Name = File_Name_1
    rem  copy .\file_in\trantf_JP_%File_Name%.inp  .\file_in\trantf_XX.inp 
   ...
   if %BUNKI_1% == y ( goto MODU_1
    ...
    :MODU_1
     ...
     gfortran -c trans_JP_hs_rate.f90      >> result_%File_Name%_%YYYYMMDD%.txt 2>&1
